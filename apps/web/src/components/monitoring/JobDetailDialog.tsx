...
export function JobDetailDialog({
	...
	// 提取失败原因渲染逻辑
	const failedReasonElement: React.ReactNode = (job?.failedReason && typeof job.failedReason === "string" ? (
				...
				{job && (
					<div className="space-y-4">
						...
						<div className="grid grid-cols-2 gap-4">
							<div>
								<div className="text-sm text-muted-foreground mb-1">任务 ID</div>
