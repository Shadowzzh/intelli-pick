...
import type { PaginationParams, PaginatedResponse } from "@intellipick/shared";
...
export const entitiesApi = {
   ...
   */
  async getTrending(params?: EntitiesQueryParams): Promise<PaginatedResponse<Entity>> {
    ...
    return api.get<PaginatedResponse<Entity>>("/api/v1/entities/trending", {
      params: queryParams,
    });
  },
