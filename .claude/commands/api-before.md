...
<quick_reference>
  ...
  <stack>Fastify 5 + Mercurius (GraphQL) + Socket.IO 4 + BullMQ 5 + Drizzle ORM</stack>
  <key_dirs>routes, services, repositories, graphql, lib</key_dirs>
  <main_files>src/index.ts, src/app.ts</main_files>
</quick_reference>
